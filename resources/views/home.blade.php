        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <h2 class="mb-5">Bạn sẽ làm gì <br> vào ngày hôm nay?</h2>
                    <ul class="list-inline widget-list-inline">
                        ...
                        <li class="list-inline-item"><a href="tags.html">Thức ăn</a></li>
                        ...
                        <li class="list-inline-item"><a href="tags.html">Hương vị</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-5">
                    <h2 class="h5 section-title">Lựa chọn của biên tập viên</h2>
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="{{ asset('themes') }}/client/images/post/post-1.jpg" class="card-img-top"
                                alt="post-thumb">
                        </div>

                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">Sử dụng táo để tạo cho món
                                    nướng của bạn màu caramel và kết cấu ẩm</a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ asset('themes') }}/client/images/john-doe.jpg">
                            ...
                            <p>Không có gì bí mật khi ngành công nghiệp kỹ thuật số đang bùng nổ. Từ các công ty khởi nghiệp
                                thú vị đến …</p>
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{ asset('themes') }}/client/images/post/post-3.jpg">
                            <div class="ml-3">
                                <h4><a href="post-details.html" class="post-title">Lời khuyên từ một Người ngoài hai
                                        mươi</a></h4>
                                <ul class="card-meta list-inline mb-0">
                                    <li class="list-inline-item mb-0">
                                        <i class="ti-calendar"></i>14 tháng 1, 2020
                                    </li>
                                    <li class="list-inline-item mb-0">
                                        <i class="ti-timer"></i>2 phút để đọc
                                    </li>
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{ asset('themes') }}/client/images/post/post-2.jpg">
                            <div class="ml-3">
                    ...
                    <article class="card mb-4">
                        <div class="card-body d-flex">
                            <img class="card-img-sm" src="{{ asset('themes') }}/client/images/post/post-4.jpg">
                            <div class="ml-3">
                ...
                <div class="col-lg-4 mb-5">
                    ...
                    <article class="card">
                        <div class="post-slider slider-sm">
                            <img src="{{ asset('themes') }}/client/images/post/post-5.jpg" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                            <h3 class="h4 mb-3"><a class="post-title" href="post-details.html">Cách Làm bánh nướng xốp và
                                    Công thức làm Cashmere tại nhà</a></h3>
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ asset('themes') }}/client/images/kate-stone.jpg" alt="Kate Stone">
                                ...
                                <li class="list-inline-item">
                                    <ul class="card-meta-tag list-inline">
                                        <li class="list-inline-item"><a href="tags.html">Thành phố</a></li>
                                        <li class="list-inline-item"><a href="tags.html">Thực phẩm</a></li>
                                        <li class="list-inline-item"><a href="tags.html">Hương vị</a></li>
                                    </ul>
                                </li>
                            </ul>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8  mb-5 mb-lg-0">
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('themes') }}/client/images/post/post-10.jpg" class="card-img-top"
                                alt="post-thumb">
                            <img src="{{ asset('themes') }}/client/images/post/post-1.jpg" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                            ...
                            <ul class="card-meta list-inline">
                                <li class="list-inline-item">
                                    <a href="author-single.html" class="card-meta-author">
                                        <img src="{{ asset('themes') }}/client/images/john-doe.jpg" alt="John Doe">
                                        <span>John Doe</span>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('themes') }}/client/images/post/post-3.jpg" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('themes') }}/client/images/post/post-7.jpg" class="card-img-top"
                                alt="post-thumb">
                        </div>
                    ...
                    <article class="card mb-4">
                        ...
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and
                    ...
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('themes') }}/client/images/post/post-8.jpg" class="card-img-top"
                                alt="post-thumb">
                            <img src="{{ asset('themes') }}/client/images/post/post-9.jpg" class="card-img-top"
                                alt="post-thumb">
                        </div>
                        <div class="card-body">
                            <h3 class="mb-3"><a class="post-title" href="post-details.html">How To Make Cupcakes and
                ...
                <aside class="col-lg-4 sidebar-home">
                    ...
                    <div class="widget widget-about">
                        ...
                        <img class="img-fluid" src="{{ asset('themes') }}/client/images/author.jpg" alt="Themefisher">
                    ...
                    <!-- Promotion -->
                    <div class="promotion">
                        <img src="{{ asset('themes') }}/client/images/promotion.jpg" class="img-fluid w-100">
                    ...
                    <div class="widget widget-author">
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image" src="{{ asset('themes') }}/client/images/john-doe.jpg">
                            </div>
                        ...
                        <div class="media align-items-center">
                            <div class="mr-3">
                                <img class="widget-author-image"
                                    src="{{ asset('themes') }}/client/images/kate-stone.jpg">
                            </div>
                            <div class="media-body">
                    ...
                    <div class="widget">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="{{ asset('themes') }}/client/images/post/post-10.jpg">
                                <div class="ml-3">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="{{ asset('themes') }}/client/images/post/post-7.jpg">
                                <div class="ml-3">
                                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a>
                                    </h5>
                                    <ul class="card-meta list-inline mb-0">
