<div class="app-menu navbar-menu fw-bold">
    <!-- LOGO -->
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="/admin" class="nav-link menu-link">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                        ...
                        <i class="ri-apps-2-line"></i> <span data-key="t-catalogues">Catalogues</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#Products" data-bs-toggle="collapse" role="button"
                        aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-medal-2-line"></i> <span data-key="t-catalogues">Products</span>
                    </a>
