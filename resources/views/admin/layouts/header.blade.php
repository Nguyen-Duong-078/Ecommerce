                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="dropdown-header">
                                <h6 class="text-overflow text-muted mb-0 text-uppercase">Gần đây Tìm kiếm</h6>
                            </div>

                            <div class="dropdown-item bg-transparent text-wrap">
                                <a href="index.html" class="btn btn-soft-secondary btn-sm rounded-pill">cách
                                    thiết lập <i class="mdi mdi-magnify ms-1"></i></a>
                                <a href="index.html" class="btn btn-soft-secondary btn-sm rounded-pill">nút
                                    <i class="mdi mdi-magnify ms-1"></i></a>
                            </div>
                            <!-- item-->
                            <div class="dropdown-header mt-2">
                                <h6 class="text-overflow text-muted mb-1 text-uppercase">Trang</h6>
                            </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                ...
                                <span>Cài đặt tài khoản của tôi</span>
                            </a>

                            <!-- item-->
                            <div class="dropdown-header mt-2">
                                <h6 class="text-overflow text-muted mb-2 text-uppercase">Thành viên</h6>
                            </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <span class="fs-11 mb-0 text-muted">Quản lý</span>
                                        </div>
                                    </div>
                                </a>
                                <!-- item -->
            ...
            <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h6 class="m-0 fw-semibold fs-15"> Ứng dụng web </h6>
                                </div>
                                <div class="col-auto">
                                    <a href="#!" class="btn btn-sm btn-soft-info"> Xem tất cả ứng dụng
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                <div class="text-center empty-cart" id="empty-cart">
                                    ...
                                    <a href="apps-ecommerce-products.html" class="btn btn-success w-md mb-3">Cửa hàng
                                        Bây giờ</a>
                                </div>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                                <a href="apps-ecommerce-product-details.html" class="text-reset">Áo
                                                    phông
                                                    Thương hiệu</a>
                                            </h6>
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge bg-light-subtle text-body fs-13"> 4 Mới</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Nguyễn Văn Dương
                                </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Xin chào Dương</h6>
                        ...
                        <a class="dropdown-item" href="apps-tasks-kanban.html"><i
                            ...
                            <span class="align-middle">Bảng tác vụ</span></a>
                        ...
                        <a class="dropdown-item" href="pages-profile.html"><i
                                ...
                                class="align-middle">Số dư : <b>$5971.67</b></span></a>
                        ...
                        <a class="dropdown-item" href="auth-lockscreen-basic.html"><i
                                ...
                                class="align-middle">Màn hình khóa</span></a>
