                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-16 mb-1">Chào buổi sáng, Anna!</h4>
                                <p class="text-muted mb-0">Sau đây là những gì đang diễn ra với cửa hàng của bạn
                                    hôm nay.</p>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="" class="text-decoration-underline">Xem tất cả
                                            đơn hàng</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="" class="text-decoration-underline">Xem
                                            chi tiết</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <a href="" class="text-decoration-underline">Rút
                                            tiền</a>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header p-0 border-0 bg-light-subtle">
                                <div class="row g-0 text-center">
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0">
                                            <h5 class="mb-1"><span class="counter-value" data-target="2289879">0</span>
                                                VNĐ
                                            </h5>
                                    ...
                                    <div class="col-6 col-sm-3">
                                        <div class="p-3 border border-dashed border-start-0 border-end-0">
                                            ...
                                            <p class="text-muted mb-0">Tỷ lệ hội thoại</p>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Doanh số theo Địa điểm</h4>
                                <div class="flex-shrink-0">
                                    <button type="button" class="btn btn-soft-primary btn-sm">
                                        Báo cáo Xuất khẩu
                                    </button>
